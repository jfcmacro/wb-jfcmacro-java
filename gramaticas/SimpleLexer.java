// $ANTLR 2.7.7 (2006-11-01): "simple2.g" -> "SimpleLexer.java"$
...
tryAgain:
	...
	public final void mDOB(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = DOB;
		int _saveIndex;
